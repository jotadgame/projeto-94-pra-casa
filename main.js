  ...
  {
	{
		if(ball_y >=450)
		{
			...
			console.log("Quando a seta para cima é pressinada, X = " + ball_x + ", Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function down()
	{
		if(ball_y <=450)
		{
			ball_y = ball_y + block_image_height;
			console.log("altura do bloco da image = " + block_image_height);
			console.log("Quando a seta para baixo é pressinada, X = " + ball_x + ", Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function left()
	{
		if(ball_x >50)
		{
			...
			console.log("altura do bloco da image = " + block_image_height);
			console.log("Quando a seta para direita é pressinada, X = " + ball_x + ", Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
		...
		{
			{
				ball_x = ball_x + block_image_height;
				console.log("altura do bloco da image = " + block_image_height);
				console.log("Quando a seta para esquerda é pressinada, X = " + ball_x + ", Y = "+ball_y);
				canvas.remove(ball_obj);
				new_image();
			}	
		}
